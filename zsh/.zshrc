...
# Automatically switch Node.js version based on .nvmrc, installing if needed
...
alias calm-app="cd ~/workspaces/camelo/mobile"
alias calm-be="cd ~/workspaces/camelo/services/sahara"
alias calm-web="cd ~/workspaces/camelo/webapp"
alias kiosk="cd ~/workspaces/camelo/kiosk"
